...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <select name="type" lay-filter="type">
            ...
            <option value="0" <?php echo e(isset($input['type'])&&$input['type']==0?'selected':''); ?>>数据缓存</option>
            <option value="1" <?php echo e(isset($input['type'])&&$input['type']==1?'selected':''); ?>>摄像头缓存</option>
        </select>
    </div>
    <div class="layui-inline">
