...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['boot_num']) ? $input['boot_num'] : ''); ?>" name="boot_num" placeholder="靴号" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['pave_num']) ? $input['pave_num'] : ''); ?>" name="pave_num" placeholder="铺号" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php echo e($info['desk']['desk_name']); ?>[<?php echo e($info['desk']['game_name']); ?>]</td>
                ...
                <td class="hidden-xs"><?php echo e($info['update_time']); ?></td>
                <td class="hidden-xs"><?php echo e($info['update_by']); ?></td>
                <td>
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-small layui-btn-danger updateGameResult" data-id="<?php echo e($info['id']); ?>" data-time="<?php echo e($info['creatime']); ?>">修改游戏结果</button>
                    </div>
                </td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            $(".updateGameResult").click(function () {
                ...
                layer.prompt({title: '请输入密码', formType: 1}, function(pass, index){
                    $.ajax({
                        ...
                        url:"<?php echo e(url('/admin/checkUpdateResultPassword')); ?>",
                        type:"post",
                        dataType:'json',
                        data:{
                            "password":pass
