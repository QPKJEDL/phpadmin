<?php $__env->startSection('title', '日数据'); ?>
<?php $__env->startSection('header'); ?>
    <div class="layui-inline" style="padding-left: 30px">
    <button class="layui-btn layui-btn-small layui-btn-warm freshBtn"><i class="layui-icon">&#x1002;</i></button>
    </div>
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['creatime']) ? $input['creatime'] : ''); ?>" name="creatime" placeholder="选择日期" onclick="layui.laydate({elem: this, festival: true,min:'<?php echo e($min); ?>' })" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['startime']) ? $input['startime'] : ''); ?>" name="startime" placeholder="选择开始时间" onclick="layui.laydate({elem: this, format:'YYYY-MM-DD hh:mm:ss',istime:true,min:'<?php echo e($today); ?>' ,max:'<?php echo e($nextday); ?>' })" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['endtime']) ? $input['endtime'] : ''); ?>" name="endtime" placeholder="选择结束时间" onclick="layui.laydate({elem: this,format:'YYYY-MM-DD hh:mm:ss',istime:true,min:'<?php echo e($today); ?>' ,max:'<?php echo e($nextday); ?>'})" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
