...
<?php $__env->startSection('content'); ?>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="category" lay-verify="required">
                <option value=""></option>
                <option value="0" <?php echo e(empty($menu)||(isset($menu['parent_id'])&&$menu['parent_id']==0)?'selected':''); ?>>一级菜单</option>
                <?php if(is_array($menus)&&$menus): ?>
                    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menus_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($menus_child['id']); ?>" <?php echo e((isset($menu['parent_id'])&&$menu['parent_id'] == $menus_child['id']) ? 'selected' : ''); ?>><?php echo e($menus_child==0?'':'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─'); ?><?php echo e($menus_child['title']); ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" value="<?php echo e(isset($menu['title']) ? $menu['title'] : ''); ?>" name="name" required lay-verify="name" placeholder="请输入名称" autocomplete="off" class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" value="<?php echo e(isset($menu['order']) ? $menu['order'] : ''); ?>" name="order" required lay-verify="order" placeholder="请输入数字" autocomplete="off" class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" name="icon" value="<?php echo e(isset($menu['icon']) ? $menu['icon'] : ''); ?>" required lay-verify="required" placeholder="请选择图标" autocomplete="off" class="layui-input" readonly>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" value="<?php echo e(isset($menu['uri']) ? $menu['uri'] : ''); ?>" name="uri" required lay-verify="uri" placeholder="请输入URL,样式如:/fzs" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <input type="checkbox" value="<?php echo e($role['id']); ?>" required <?php echo e(isset($menu['roleIds'])&&in_array($role['id'],$menu['roleIds'])?'checked':''); ?> lay-filter="roles_check" name="roles[]" title="<?php echo e($role['display_name']); ?>">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <script>
        ...
        layui.use(['form','laypage', 'layer'], function() {
            ...
            form.on('submit(formDemo)', function(data) {
                ...
                $.ajax({
                    url:"<?php echo e(url('/admin/menus')); ?>",
                    data:$('form').serialize(),
                    type:'post',
                    dataType:'json',
