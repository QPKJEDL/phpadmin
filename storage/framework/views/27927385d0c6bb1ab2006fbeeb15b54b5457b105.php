...
<?php $__env->startSection('content'); ?>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" value="<?php echo e(isset($info['account']) ? $info['account'] : ''); ?>" name="account" required lay-verify="tel" placeholder="请输入手机号"  autocomplete="off" class="layui-input" <?php if($id!=0): ?> disabled <?php endif; ?>>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" value="<?php echo e(isset($info['shenfen']) ? $info['shenfen'] : ''); ?>" name="shenfen" lay-verify="shenfen" placeholder="请输入身份(1-15)" autocomplete="off" class="layui-input" <?php if($id!=0): ?> disabled <?php endif; ?>>
        </div>
    </div>
    <?php if($id==0): ?>
    <div class="layui-form-item">
