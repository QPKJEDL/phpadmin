        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td style="text-align: center">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-small layui-btn-normal edits-btn" data-id="<?php echo e($info['order_sn']); ?>" data-desc="补单">补单</button>
                    </div>
                </td>
            </tr>
            ...
            $('.edits-btn').click(function () {
                ...
                layer.confirm('确定要补单吗？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"<?php echo e(url('/admin/order/budan')); ?>",
                            data:{
                                "order_sn":order_sn,
                            },
                            type:"post",
