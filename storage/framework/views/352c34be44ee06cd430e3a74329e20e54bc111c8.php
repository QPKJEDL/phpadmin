...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input type="text" value="<?php echo e(isset($input['order_sn']) ? $input['order_sn'] : ''); ?>" name="order_sn" placeholder="请输入提现号" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
        <input class="layui-input" name="creatime" placeholder="申请日期" onclick="layui.laydate({elem: this, festival: true,min:'2019-11-11'})" value="<?php echo e(isset($input['creatime']) ? $input['creatime'] : ''); ?>" autocomplete="off">
    </div>
    <div class="layui-inline">
        <input class="layui-input" name="endtime" placeholder="审核日期" onclick="layui.laydate({elem: this, festival: true,min:'2019-11-11'})" value="<?php echo e(isset($input['endtime']) ? $input['endtime'] : ''); ?>" autocomplete="off">
    </div>
    <div class="layui-inline">
            ...
            $('.edits-btn1').click(function () {
                ...
                layer.confirm('确定要打款？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"<?php echo e(url('/admin/busdrawreject/pass')); ?>",
                            data:{
                                "order_sn":order_sn,
                            },
                            type:"post",
            ...
            $('.edits-btn2').click(function () {
                ...
                layer.confirm('确认驳回？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"<?php echo e(url('/admin/busdrawreject/reject')); ?>",
                            data:{
                                "order_sn":order_sn,
                            },
                            type:"post",
