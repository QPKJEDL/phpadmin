...
<?php $__env->startSection('header'); ?>
    <div class="layui-inline">
        <button class="layui-btn layui-btn-small layui-btn-normal addNotice" data-desc="添加公告" data-url="<?php echo e(url('/admin/notices/0/edit')); ?>"><i class="layui-icon">&#xe654;</i></button>
