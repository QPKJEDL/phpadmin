...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input class="layui-input" name="endtime" placeholder="提现日期" onclick="layui.laydate({elem: this, festival: true,min:'<?php echo e($min); ?>'})" value="<?php echo e(isset($input['endtime']) ? $input['endtime'] : ''); ?>" autocomplete="off">
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php echo e($info['order_no']); ?></td>
            ...
            $('.edits-btn1').click(function () {
                ...
                layer.confirm('确定要通过吗？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"<?php echo e(url('/admin/codedrawnone/pass')); ?>",
                            data:{
                                "id":id,
                            },
                            type:"post",
            ...
            $('.edits-btn2').click(function () {
                ...
                layer.confirm('确定要驳回吗？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"<?php echo e(url('/admin/codedrawnone/reject')); ?>",
                            data:{
                                "id":id,
                            },
                            type:"post",
