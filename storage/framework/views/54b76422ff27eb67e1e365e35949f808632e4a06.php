...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input class="layui-input" name="endtime" placeholder="驳回日期" onclick="layui.laydate({elem: this, festival: true,min:'<?php echo e($min); ?>'})" value="<?php echo e(isset($input['endtime']) ? $input['endtime'] : ''); ?>" autocomplete="off">
    </div>
    <div class="layui-inline">
