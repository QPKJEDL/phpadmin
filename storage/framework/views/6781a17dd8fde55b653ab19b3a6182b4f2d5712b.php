    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php if($info['status']==0): ?><span class="layui-btn layui-btn-small layui-btn">正常</span><?php elseif($info['status']==1): ?><span class="layui-btn layui-btn-small layui-btn-danger">不正常</span><?php endif; ?></td>
