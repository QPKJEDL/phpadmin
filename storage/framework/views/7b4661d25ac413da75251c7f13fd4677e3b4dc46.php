    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $pager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php if($info['take_status']==0): ?><span class="layui-btn layui-btn-small">未接单</span><?php elseif($info['take_status']==1): ?><span class="layui-btn layui-btn-small layui-btn-warm">已接单</span><?php endif; ?></td>
                <td class="hidden-xs">
