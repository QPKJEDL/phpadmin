            ...
            <div class="server-panel panel panel-default">
                ...
                <div class="panel-body clearfix">
                    <div class="col-md-2">
                        ...
                        <span class="info"><?php echo e($sysinfo['web_server']); ?></span>
                    </div>
                    <div class="col-md-2">
                        <p class="title">服务器IP地址</p>
                        <span class="info"><?php echo e($sysinfo['ip']); ?></span>
                    </div>
                    <div class="col-md-2">
                        <p class="title">服务器域名</p>
                        <span class="info"><?php echo e($sysinfo['domain']); ?></span>
                    </div>
                    <div class="col-md-2">
                        <p class="title"> PHP版本</p>
                        <span class="info"><?php echo e($sysinfo['phpv']); ?></span>
                    </div>
                    <div class="col-md-2">
                        <p class="title">数据库信息</p>
                        <span class="info"><?php echo e($sysinfo['mysql_version']); ?></span>
                    </div>
                    <div class="col-md-2">
                        <p class="title">服务器当前时间</p>
                        <span class="info"><?php echo e($sysinfo['time']); ?></span>
                    </div>
                </div>
            </div>
        </div>
