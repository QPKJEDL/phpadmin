            ...
            <form class="layui-form"  style="width: 90%;padding-top: 20px;" id="info_form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="username" disabled autocomplete="off" class="layui-input layui-disabled" value="<?php echo e($userinfo['username']); ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">邮箱：</label>
                    <div class="layui-input-block">
                        <input type="text" name="useremail" required  lay-verify="required|email" placeholder="请输入标题" autocomplete="off" class="layui-input" value="<?php echo e($userinfo['email']); ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">手机号：</label>
                    <div class="layui-input-block">
                        <input type="text" name="usertel" required  lay-verify="required|phone" placeholder="请输入标题" autocomplete="off" class="layui-input" value="<?php echo e($userinfo['mobile']); ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="usersex" value="1" title="男"
                               ...
                               checked
                               <?php elseif(isset($userinfo['sex'])&&$userinfo['sex']): ?>
                               checked
                                <?php else: ?>
                                <?php endif; ?>>
                        <input type="radio" name="usersex" value="0" title="女" <?php echo e(isset($userinfo['sex'])&&!$userinfo['sex']?'checked':''); ?>>
                    </div>

                </div>
                <input name="id" type="hidden" value="<?php echo e(isset($userinfo['id']) ? $userinfo['id'] : 0); ?>">
                <div class="layui-form-item">
                    <div class="layui-input-block">
...
<script>
    layui.use(['form','jquery','element'], function(){
        ...
        form.on('submit(adminInfo)', function(data){
            $.ajax({
                url:"<?php echo e(url('/admin/saveinfo/1')); ?>",
        ...
        form.on('submit(adminPassword)', function(data){
            $.ajax({
                url:"<?php echo e(url('/admin/saveinfo/2')); ?>",
