<?php $__env->startSection('title', '充值通过列表'); ?>
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['creatime']) ? $input['creatime'] : ''); ?>" name="creatime" placeholder="申请时间" onclick="layui.laydate({elem: this, festival: true,})" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
