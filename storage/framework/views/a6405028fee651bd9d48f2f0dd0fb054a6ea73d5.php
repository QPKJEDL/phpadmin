...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($own_id) ? $own_id : ''); ?>" name="user_id"  class="layui-input" disabled>
    </div>
    <div class="layui-inline">
    ...
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['erweima_id']) ? $input['erweima_id'] : ''); ?>" name="erweima_id" placeholder="请输入二维码号" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs">
                    ...
                    <?php elseif($info['status']==2): ?><span class="layui-btn layui-btn-small layui-btn">第三方支付</span>
                    <?php elseif($info['status']==3): ?><span class="layui-btn layui-btn-small layui-btn-disabled">冻结</span>
                    <?php elseif($info['status']==4): ?><span class="layui-btn layui-btn-small layui-btn-warm">充值解冻</span>
                    <?php elseif($info['status']==5): ?><span class="layui-btn layui-btn-small layui-btn-normal">佣金</span>
