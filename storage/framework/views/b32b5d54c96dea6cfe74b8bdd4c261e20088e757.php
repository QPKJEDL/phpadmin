...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input type="text"  value="<?php echo e(isset($input['ip_address']) ? $input['ip_address'] : ''); ?>" name="ip_address" placeholder="请输入IP" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php echo e($info['ip_address']); ?></td>
                <td class="hidden-xs"><?php echo e($info['start_date']); ?></td>
                <td class="hidden-xs"><?php echo e($info['end_date']); ?></td>
