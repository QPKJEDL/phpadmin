    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="force" lay-verify="required">
                ...
                <option value="0" <?php if(isset($info['force'])&&$info['force']==0): ?> selected <?php endif; ?>>非强制更新</option>
                <option value="1" <?php if(isset($info['force'])&&$info['force']==1): ?> selected <?php endif; ?>>强制更新</option>
            </select>
        </div>
    </div>
