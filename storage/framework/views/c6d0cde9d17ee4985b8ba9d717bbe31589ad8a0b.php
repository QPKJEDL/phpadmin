...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input class="layui-input" name="creatime" placeholder="申请日期" onclick="layui.laydate({elem: this, festival: true})" autocomplete="off" value="<?php echo e(isset($input['creatime']) ? $input['creatime'] : ''); ?>">
    </div>
    <div class="layui-inline">
        <input class="layui-input" name="endtime" placeholder="审批日期" onclick="layui.laydate({elem: this, festival: true})" autocomplete="off" value="<?php echo e(isset($input['endtime']) ? $input['endtime'] : ''); ?>">
    </div>
    <div class="layui-inline">
