    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php echo e($info['desk_id']); ?></td>
                <td class="hidden-xs"><?php echo e($info['desk_name']); ?></td>
                <td class="hidden-xs"><?php echo e($info["boot_num"]); ?></td>
                <td class="hidden-xs"><?php echo e($info["pave_num"]); ?></td>
                <td class="hidden-xs"><?php echo e($info['bet_money']); ?></td>
                <td class="hidden-xs"><?php echo e($info['get_money']/100); ?></td>
                <td class="hidden-xs"><?php echo e($info['status']); ?></td>
                <td class="hidden-xs"><?php echo e($info['creatime']); ?></td>
                <td class="hidden-xs"><?php echo e($info['paytime']); ?></td>
            </tr>
