<?php $__env->startSection('title', '代理商流失'); ?>
    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs">                   
                    <?php if($info['status']==1): ?><span class="layui-btn layui-btn-small layui-btn-primary">支付</span>
                    <?php elseif($info['status']==2): ?><span class="layui-btn layui-btn-small layui-btn-normal">利润</span>
                    <?php elseif($info['status']==3): ?><span class="layui-btn layui-btn-small layui-btn-danger">提现</span>
                    <?php endif; ?>
                </td>
                <td class="hidden-xs">
                    <?php if($info['paycode']==0): ?><span class="layui-btn layui-btn-small layui-btn-primary">默认</span>
                    <?php elseif($info['paycode']==1): ?><span class="layui-btn layui-btn-small">微信</span>
