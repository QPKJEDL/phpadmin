...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input class="layui-input" name="creatime" placeholder="选择日期" onclick="layui.laydate({elem: this, festival: true,min:'<?php echo e($min); ?>'})" value="<?php echo e(isset($input['creatime']) ? $input['creatime'] : ''); ?>" autocomplete="off">
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php echo e($info['done_rate']); ?>%</td>
                <td class="hidden-xs"><?php echo e($info['sk_money']); ?></td>
                <td class="hidden-xs"><?php echo e($info['tradeMoney']); ?></td>
                <td class="hidden-xs"><?php echo e($info['draw_money']); ?></td>
                <td class="hidden-xs"><?php echo e($info['draw_tradeMoney']); ?></td>
                <td class="hidden-xs"><?php echo e($info['profit']); ?></td>
            </tr>
