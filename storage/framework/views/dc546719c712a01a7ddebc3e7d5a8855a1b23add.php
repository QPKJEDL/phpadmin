...
<?php $__env->startSection('header'); ?>
    ...
    <div class="layui-inline">
        <input class="layui-input" name="begin" placeholder="开始日期" onclick="layui.laydate({elem: this, festival: true,min:'<?php echo e($min); ?>'})" value="<?php echo e(isset($input['begin']) ? $input['begin'] : ''); ?>" autocomplete="off">
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table" lay-even lay-skin="nob">
        ...
        <?php $__currentLoopData = $pager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs"><?php echo e($list['name']); ?></td>
                <td class="hidden-xs"><?php echo e($list['shenfen']); ?></td>
                <td class="hidden-xs"><?php echo e($list['log_info']); ?></td>
                <td class="hidden-xs"><?php echo e($list['log_url']); ?></td>
                <td class="hidden-xs"><?php echo e($list['log_ip']); ?></td>
                <td class="hidden-xs"><?php echo e($list['log_time']); ?></td>
            </tr>
