        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td class="hidden-xs">
                    ...
                    <?php elseif($info['callback_status']==2): ?><span class="layui-btn layui-btn-small layui-btn-danger">推送失败</span>
                    <?php endif; ?>
                </td>
                <td class="hidden-xs"><?php echo e($info['creatime']); ?></td>
                <td class="hidden-xs"><?php echo e($info['pay_time']); ?></td>
                <td style="text-align: center">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-small layui-btn-warm edits-btn"  data-id="<?php echo e($info['order_sn']); ?>" data-desc="手动回调">手动回调</button>
                    </div>
                </td>
            </tr>
            ...
            $('.edits-btn').click(function () {
                ...
                layer.confirm('确定要手动回调吗？',{title:'提示'},function (index) {
                        $.ajax({
                            ...
                            url:"<?php echo e(url('/admin/order/sfpushfirst')); ?>",
                            data:{
                                "order_sn":order_sn,
                            },
                            type:"post",
